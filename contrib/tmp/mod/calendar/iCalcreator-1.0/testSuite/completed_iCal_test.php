...
$o = new vtodo();
$o->setProperty( 'Completed', 1, 2, 3, 4, 5, 6 );
...
$o = new vtodo();
$o->setProperty( 'Completed', array( 'year' => 1, 'month' => 2, 'day' => 3 ));
...
$o = new vtodo();
$o->setProperty( 'Completed', '02/03/2001', array ( 'jestanes', 'xkey' => 'xvalue', 'xxx' => 'yyy' ) );
