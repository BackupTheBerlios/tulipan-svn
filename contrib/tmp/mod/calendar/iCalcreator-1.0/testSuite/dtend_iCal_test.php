...
$o->setDtend( array( 1, 2, 3 ), array( 'VALUE' => 'DATE-TIME' ));
$c->addComponent( $o );
...
$o->setDtend( array( 'day'=>3, 'month'=>2, 'year'=>1 ), array( 'VALUE' => 'DATE' ));
$c->addComponent( $o );
...
$o->setDtend( array( 1, 2, 3, 4, 5, 6, 'Europe/Stockholm' ));
$c->addComponent( $o );
...
$o->setDtend( array( 1, 2, 3, 4, 5, 6, 'Europe/Stockholm' ), array( 'VALUE' => 'DATE-TIME' ));
$c->addComponent( $o );

$o = new vevent();
$o->setComment( 'A2j: long array( sec=>6,min=>5,hour=>4,day=>3,month=>2,year=>1 ), array with keys' );
$o->setProperty( 'dtend', array( 'sec'=>6, 'min'=>5, 'hour'=>4, 'day'=>3, 'month'=>2, 'year'=>1 ));
$c->addComponent( $o );

$o = new vevent();
$o->setComment( 'A2k: long array( sec=>6,min=>5,hour=>4,day=>3,month=>2,year=>1 ), array with keys, param: array(VALUE=>DATE)' );
$o->setDtend( array( 'sec'=>6, 'min'=>5, 'hour'=>4, 'day'=>3, 'month'=>2, 'year'=>1 ), array( 'VALUE' => 'DATE' ));
$c->addComponent( $o );
...
$o->setDtend( array( 'sec'=>6, 'min'=>5, 'hour'=>4, 'day'=>3, 'month'=>2, 'year'=>1, 'tz'=>'+0400' ));
$c->addComponent( $o );
...
$o->setDtend( array( 'sec'=>6, 'min'=>5, 'hour'=>4, 'day'=>3, 'month'=>2, 'year'=>1, 'tz'=>'+0400' ), array( 'VALUE'=>'DATE-TIME' ));
$c->addComponent( $o );

$o = new vevent();
$o->setComment( 'A2q: long array( sec=>6,min=>5,hour=>4,day=>3,month=>2,year=>1,tz=CEST), array with keys and timezone' );
$o->setProperty( 'Dtend'
                ,array('sec'=>6,'min'=>5,'hour'=>4,'day'=>3,'month'=>2,'year'=>1,'tz'=>'CEST'));
$c->addComponent( $o );
...
$o->setDtend( array( 'sec'=>6, 'min'=>5, 'hour'=>4, 'day'=>3, 'month'=>2, 'year'=>1, 'tz'=>'Europe/Stockholm' ), array( 'VALUE'=>'DATE' ));
$c->addComponent( $o );
...
$o->setDtend( array( 'sec'=>6, 'min'=>5, 'hour'=>4, 'day'=>3, 'month'=>2, 'year'=>1, 'tz'=>'Europe/Stockholm' ), array( 'VALUE'=>'DATE', 'TZID'=>'Europe/Helsinki' ));
$c->addComponent( $o );
...
$o->setDtend( array( 'timestamp' => $timestamp, 'tz' => '+0100' ), array ( 'jestanes', 'xkey' => 'xvalue', 'xxx' => 'yyy', 'VALUE' => 'DATE' ) );
$c->addComponent( $o );
...
$o->setDtend( '2001-02-03 04:05:06 US-Eastern', array( 'VALUE' => 'DATE-TIME' ) );
$c->addComponent( $o );
...
$o->setProperty( 'Dtend', 1, 2, 3, 4, 5, 6 );
$c->addComponent( $o );
...
$o->setDtend( 2006, 8, 11, 16, 30, 0, '-040000', array( 'VALUE' => 'DATE-TIME' ) ); // 11 august 2006 16.30.00 -040000
$c->addComponent( $o );
...
$o->setDtend( 2006, 8, 11, 16, 30, 0, 'Europe/Stockholm', array( 'VALUE' => 'DATE' )); // 11 august 2006 16.30.00 -040000
$c->addComponent( $o );
