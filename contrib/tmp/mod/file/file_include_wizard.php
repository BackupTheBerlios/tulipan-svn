 ...
 */
 ...
 $user_files = get_records('files','folder',$folder_id/*,"owner",$owne*/);
 ...
 if(!empty($user_files)){
   ...
   foreach($user_files as $file){
     ...
     $files.="<li><a class=\"mediafile$type\" href=\"#\" onclick=\"insertFile('$field','$file->ident')\">$file_name</a>$delete</li>";
   }
   $files.="</ul>";
 }
 else{
