...
END;
            ...
            $body .= <<< END
                <li>
				<a href="{$CFG->wwwroot}mod/forum/forum.php?owner=$page_owner">$communityWeblog</a>
				
 (<a href="{$CFG->wwwroot}{$weblog_username}/weblog/rss">RSS</a>)</li>
END;
        }
        $blogArchive = __gettext("Archive");
